...
@section('content')
<div class="p-8 bg-[#EEF1F7] min-h-screen">
    ...
    <div class="grid grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-xl shadow p-6 text-center">
            ...
            <div class="w-24 h-24 mx-auto rounded-full overflow-hidden mb-4">
                ...
                @else
                    <div class="w-full h-full bg-indigo-400 flex items-center justify-center text-white text-3xl">
        ...
        <div class="col-span-2 bg-white rounded-xl shadow p-8">
            ...
            <form method="POST"
                  action="{{ route('petugas.settings.update') }}"
